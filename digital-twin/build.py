...
# Fonctions/constantes partagées (stdlib pur) — ré-exportées ici pour compatibilité.
from blocks_util import PAPERS, COLORS, paper_name, _iou, dedup_blocks  # noqa: F401
